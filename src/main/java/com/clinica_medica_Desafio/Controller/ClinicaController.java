...
public class ClinicaController {
	...
	public ResponseEntity<ClinicaDTO> find(@PathVariable Long id) {
	    ...
	    } catch (ClinicaIdInvalidException e) {
	        throw e;
	    } catch (ClinicaNotFoundException e) {
	        throw e;
	    } catch (DataAcessException e) {
	        throw new DataAcessException("Erro ao buscar clínica");
	    }
	}
	...
	public ResponseEntity<ClinicaDTO> adicionarEspecialidade(@PathVariable Long id,@RequestBody ClinicaDTO clinicaDTO) {
